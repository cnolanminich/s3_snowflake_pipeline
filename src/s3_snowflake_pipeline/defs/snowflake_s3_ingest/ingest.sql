-- Ingest data from an S3 external stage into Snowflake using COPY INTO.
-- This approach uses Snowflake-native S3 integration (external stages)
-- rather than third-party tools like dlt or Sling.
--
-- Prerequisites:
